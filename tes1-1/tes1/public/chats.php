            ...
            <div class="chat-info">
                ...
                <?php else: ?>
                    <?php 
                        ...
                        if (!empty($row['encryption_key']) && !empty($previewText)) {
                            $previewText = superDecrypt($row['message_text'], $row['encryption_key']);
                        }
                        $previewText = mb_strimwidth($previewText, 0, 40, '...');
                    ?>
                    <span><?php echo htmlspecialchars($previewText); ?></span>
                <?php endif; ?>
